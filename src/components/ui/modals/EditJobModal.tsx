...
v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
                                    ...
                                    <div className="ml-3">
                                        <p className="text-sm text-blue-700">
                                            To update the job status to &apos;In_Progress&apos; or &apos;Completed&apos;, you must assign at least one freelancer to this job. Use the search below to find and select freelancers by their username.
                                        </p>
                                    </div>
                                </div>
                            </div>
