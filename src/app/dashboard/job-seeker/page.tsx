...
function JobSeekerDashboard() {
    ...
    const [currentTab, setCurrentTab] = useState<'Best Matches' | 'Most Recent' | 'Nearby'>('Nearby');
    ...
    const { jobs: nearByJobs, isLoading, isError, mutate } = useNearbyJobs(latitude, longitude);
                        ...
                        <div className="lg:col-span-9 py-6">
                            <div className="bg-white rounded-xl p-8 text-center shadow-sm">
                                ...
                                <p className="text-gray-600 mb-6">
                                    Please update your profile with your location to see nearby jobs.
                                </p>
                                <button
    ...
    if (recommendedError) {
        return (
            <ErrorNearBy mutate={recommendedMutate} />
        );
    }
                                            ...
                                            <>
                                                {nearByJobs.length === 0 ? (
                                                    <div className="text-center py-12">
                                                        ...
                                                        <p className="text-gray-600 mb-6">
                                                            There are no jobs within 10km of your location. Try expanding your search area.
                                                        </p>
                                                        <button
                                                            onClick={() => mutate()}
                                                            className="bg-primary text-white px-6 py-3 rounded-xl font-semibold hover:bg-primary/90 transition-colors"
                                                                                    ...
                                                                                    {job.matchedSkills && job.matchedSkills.length > 0 && (
                                                                                        <div className="mt-3">
                                                                                            <div className="flex flex-wrap gap-1">
                                                                                                <span className="text-xs text-gray-500 mr-2">Matched skills:</span>
