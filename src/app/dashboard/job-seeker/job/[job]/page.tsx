                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-yellow-700 text-xs sm:text-sm mt-1">
                      Verify your document to access messaging, calling, saving, reporting, applying and
                      location features.
                    </p>
                  </div>
                </div>
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-red-500 text-sm font-semibold leading-relaxed">
                    Payment varies based on experience, qualifications, and
                    project scope. Contact the job provider for details before
                    applying. Thank you for your proactive approach.
                  </p>
                </div>
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-yellow-700 text-sm">
                                You can only review job providers you have
                                worked with before. Complete a job with this
                                provider to unlock the review feature.
                              </p>
                            </div>
                          </div>
                        </div>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl max-w-md w-full p-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-gray-600">
                This is the job location. Exact address will be shared after
