...
import { useNearbyProviders } from "@/hooks/useNearByProvider";
import { useUserLocation } from "@/hooks/useUserLocation";
import NearByJobProviderPagination from "@/components/near-by-provider/NearByProviderPagination";
...
export default function NearByBuyerPage() {
    const router = useRouter();
    const { latitude, longitude } = useUserLocation();

    const [currentPage, setCurrentPage] = useState<number>(1);

    const { users: jobProviders, pagination, isLoading, isError, mutate } = useNearbyProviders(currentPage, latitude || undefined, longitude || undefined);
                    ...
                    <div className="lg:col-span-6 py-6">
                        ...
                        <div className="mb-6 flex items-center justify-between ">
                            ...
                            >
                                ...
                                <h1 className="text-xl font-bold text-gray-900">Near by Buyers</h1>
                            </button>
                            <div>
