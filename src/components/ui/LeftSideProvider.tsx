                ...
                <div className="sticky top-6 space-y-6">
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-sm">
                        <div className="text-center">
                            ...
                            <Link href={"/dashboard/job-provider/profile/edit-profile"} className="w-full bg-primary/10 text-primary py-2 px-4 rounded-lg font-semibold hover:bg-primary/20 transition-colors">
                                Edit Profile
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-sm">
                        ...
                        <div className="space-y-3">
                            <Link
                                href={'/dashboard/job-provider/create-job'}
                            ...
                            <Link href="/dashboard/job-provider/my-review" className="w-full flex items-center gap-3 p-3 text-left hover:bg-gray-50 rounded-lg transition-colors">
